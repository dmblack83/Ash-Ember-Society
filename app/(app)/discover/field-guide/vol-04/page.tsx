    ...
    <ArticleShell
      ...
      meta={
        <>
          ...
          <span style={{ color: S.ember }}>&bull;</span>
      ...
      >
        ...
        >
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <span style={{ fontSize: 9.5, fontWeight: 600, letterSpacing: "0.28em", textTransform: "uppercase", color: S.fg3 }}>Draw</span>
            <span style={{ fontFamily: S.serif, fontSize: 17, fontWeight: 600, color: S.gold, lineHeight: 1.2 }}>Open</span>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <span style={{ fontSize: 9.5, fontWeight: 600, letterSpacing: "0.28em", textTransform: "uppercase", color: S.fg3 }}>Difficulty</span>
            <Pips on={3} />
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <span style={{ fontSize: 9.5, fontWeight: 600, letterSpacing: "0.28em", textTransform: "uppercase", color: S.fg3 }}>Best On</span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 24 }}>
          <div>
            <h4 style={{ margin: "0 0 10px", fontFamily: S.sans, fontSize: 10.5, fontWeight: 600, letterSpacing: "0.3em", textTransform: "uppercase", color: S.gold }}>
              In Its Favor
            </h4>
          ...
          <div>
            <h4 style={{ margin: "0 0 10px", fontFamily: S.sans, fontSize: 10.5, fontWeight: 600, letterSpacing: "0.3em", textTransform: "uppercase", color: S.ember }}>
              Against
            </h4>
            <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: 8 }}>
