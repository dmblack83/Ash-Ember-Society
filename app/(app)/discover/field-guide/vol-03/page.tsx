  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ borderTop: "1px solid rgba(212,160,74,0.2)", paddingTop: 14 }}>
            <div style={{ fontFamily: S.serif, fontStyle: "italic", color: S.gold, fontSize: 17, marginBottom: 4 }}>
              Length
            </div>
            <div style={{ fontFamily: S.sans, fontSize: 13.5, color: S.fg2, lineHeight: 1.55 }}>
              Foot to cap, in inches. The smoking time. A Robusto runs 5&Prime;; a Churchill, 7&Prime;.
            </div>
          </div>
          <div style={{ borderTop: "1px solid rgba(212,160,74,0.2)", paddingTop: 14 }}>
            <div style={{ fontFamily: S.serif, fontStyle: "italic", color: S.gold, fontSize: 17, marginBottom: 4 }}>
            ...
            <div style={{ fontFamily: S.sans, fontSize: 13.5, color: S.fg2, lineHeight: 1.55 }}>
              Diameter in 64ths of an inch. Bigger numbers = thicker cigar. The wrapper-to-filler ratio.
            </div>
          </div>
        </div>
        <div
        ...
        >
          {[
            ...
            <div key={t.rg} style={{ textAlign: "center" }}>
              <div style={{ fontFamily: S.serif, fontStyle: "italic", fontSize: 22, color: S.gold, lineHeight: 1 }}>
                {t.rg}
              </div>
              <div
                style={{
      ...
      >
        ...
        <tbody>
          <tr>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontWeight: 600, fontSize: 16, verticalAlign: "top", color: S.fg1 }}>
              Corona
              <span style={{ display: "block", fontFamily: S.serif, fontStyle: "italic", fontWeight: 400, color: S.gold, fontSize: 12, marginTop: 3 }}>
                the classic
              </span>
            </td>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontStyle: "italic", fontSize: 14, color: S.gold, verticalAlign: "top", whiteSpace: "nowrap" }}>
              5.5&ndash;6&Prime; &times; 42&ndash;44
              <span style={{ display: "block", color: S.fg3, fontFamily: S.sans, fontStyle: "normal", fontSize: 12, letterSpacing: "0.1em", textTransform: "uppercase", marginTop: 4 }}>~45 min</span>
            </td>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", color: S.fg2, fontSize: 13.5, lineHeight: 1.55, verticalAlign: "top" }}>
              The original benchmark, against which everything else used to be measured. Slower burn, more elegant, restrained. A connoisseur&apos;s reminder of what cigars were before the obsession with girth.
            </td>
          </tr>
          <tr>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontWeight: 600, fontSize: 16, verticalAlign: "top", color: S.fg1 }}>
            ...
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontStyle: "italic", fontSize: 14, color: S.gold, verticalAlign: "top", whiteSpace: "nowrap" }}>
              5&ndash;5.5&Prime; &times; 50
              <span style={{ display: "block", color: S.fg3, fontFamily: S.sans, fontStyle: "normal", fontSize: 12, letterSpacing: "0.1em", textTransform: "uppercase", marginTop: 4 }}>~45&ndash;60 min</span>
            </td>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", color: S.fg2, fontSize: 13.5, lineHeight: 1.55, verticalAlign: "top" }}>
              Quick to light, intense in flavor, the most popular size in modern American cigar culture. What to reach for when there is time for a real cigar but not time for a long one.
            </td>
          </tr>
          <tr>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontWeight: 600, fontSize: 16, verticalAlign: "top", color: S.fg1 }}>
            ...
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontStyle: "italic", fontSize: 14, color: S.gold, verticalAlign: "top", whiteSpace: "nowrap" }}>
              6&ndash;6.5&Prime; &times; 50
              <span style={{ display: "block", color: S.fg3, fontFamily: S.sans, fontStyle: "normal", fontSize: 12, letterSpacing: "0.1em", textTransform: "uppercase", marginTop: 4 }}>~60&ndash;90 min</span>
            </td>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", color: S.fg2, fontSize: 13.5, lineHeight: 1.55, verticalAlign: "top" }}>
              The current king of the American market. A bit more length than a Robusto, same diameter, adds time without changing the basic flavor character. The default house cigar.
            </td>
          </tr>
          <tr>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontWeight: 600, fontSize: 16, verticalAlign: "top", color: S.fg1 }}>
            ...
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontStyle: "italic", fontSize: 14, color: S.gold, verticalAlign: "top", whiteSpace: "nowrap" }}>
              7&ndash;7.5&Prime; &times; 47&ndash;50
              <span style={{ display: "block", color: S.fg3, fontFamily: S.sans, fontStyle: "normal", fontSize: 12, letterSpacing: "0.1em", textTransform: "uppercase", marginTop: 4 }}>~90&ndash;120 min</span>
            </td>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", color: S.fg2, fontSize: 13.5, lineHeight: 1.55, verticalAlign: "top" }}>
              Named after Winston, who smoked the Romeo y Julieta version every day for half a century. A cigar to plan an evening around.
            </td>
          </tr>
          <tr>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontWeight: 600, fontSize: 16, verticalAlign: "top", color: S.fg1 }}>
            ...
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", fontFamily: S.serif, fontStyle: "italic", fontSize: 14, color: S.gold, verticalAlign: "top", whiteSpace: "nowrap" }}>
              6&ndash;6.5&Prime; &times; 60+
              <span style={{ display: "block", color: S.fg3, fontFamily: S.sans, fontStyle: "normal", fontSize: 12, letterSpacing: "0.1em", textTransform: "uppercase", marginTop: 4 }}>~90+ min</span>
            </td>
            <td style={{ padding: "16px 14px", borderBottom: "1px solid rgba(212,160,74,0.14)", color: S.fg2, fontSize: 13.5, lineHeight: 1.55, verticalAlign: "top" }}>
              The modern fat-cigar phenomenon. Traditionalists hate them, a 60-ring quiets the wrapper and changes the balance. A great Gordo is still a great cigar. Personal preference territory.
            </td>
          </tr>
        </tbody>
      </table>
      ...
      >
        ...
        >
          The <em style={{ fontStyle: "italic", color: S.gold, fontWeight: 400 }}>Lancero</em>
        </h3>
        <div
          style={{
            fontFamily: S.serif,
        ...
        >
          7&ndash;7.5&Prime; &times; 38&ndash;40 ring gauge
        </div>
          ...
          {[
            {
              name: "Lonsdale",
              dim:  "6\u20136.75\u2033 \u00d7 42\u201344",
              desc: "A longer, slimmer corona. Classic in the Cuban tradition; missed by anyone who knows what they are missing.",
            },
            {
              name: "Petit Corona",
              dim:  "4.5\u20135\u2033 \u00d7 40\u201342",
              desc: "The little brother. A thirty-minute smoke when there is time for quality but not for length.",
            },
            {
              name: "Double Corona",
              dim:  "7.5\u20138\u2033 \u00d7 49\u201352",
              desc: "The grand format. Full-bodied, two hours. The Hoyo de Monterrey is legendary.",
            },
          ].map((item, i) => (
            <div
              key={item.name}
            ...
            >
              <div style={{ fontFamily: S.serif, fontWeight: 600, fontSize: 16, marginBottom: 4, color: S.fg1 }}>
                {item.name}
              </div>
              <div style={{ fontFamily: S.serif, fontStyle: "italic", color: S.gold, fontSize: 12, marginBottom: 6 }}>
                {item.dim}
              </div>
              <div style={{ fontFamily: S.sans, fontSize: 12.5, color: S.fg3, lineHeight: 1.5 }}>
                {item.desc}
              </div>
            </div>
          ))}
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
            <div style={{ fontFamily: S.serif, fontWeight: 600, fontSize: 22, letterSpacing: "0.16em", textTransform: "uppercase", color: S.fg1, marginBottom: 4 }}>
              Parejo
            </div>
            <div style={{ fontFamily: S.serif, fontStyle: "italic", color: S.gold, fontSize: 13, marginBottom: 22 }}>
              Straight
            </div>
            <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <div style={{ fontFamily: S.serif, fontStyle: "italic", fontSize: 11.5, color: S.gold, marginTop: 2 }}>
                  uniform gauge
                </div>
              </div>
            </div>
          ...
          <div
            style={{
              width:      1,
              background: "linear-gradient(180deg, transparent, rgba(212,160,74,0.4) 20%, rgba(212,160,74,0.4) 80%, transparent)",
              alignSelf:  "stretch",
            }}
          />
      ...
      <p style={{ fontSize: 17, lineHeight: 1.78, color: S.fg1, margin: "0 0 22px" }}>
        The figurados worth knowing by name:
      </p>
      ...
      >
        {[
          {
            name:  "Torpedo",
            gloss: "Straight body, pointed cap",
            desc:  "The pointed cap concentrates smoke into a narrower stream as it crosses the palate, which sharpens the flavor. Also a roller\u2019s flex, harder to make well. A great torpedo is one of the most pleasurable cigars on earth.",
          },
          {
            name:  "Pyramid",
            gloss: "A true tapered cone",
            desc:  "Tapered from foot to cap. Starts with a wide-open foot for an easy light and a rich initial draw, then narrows toward the cap, so flavor concentration shifts as the cigar burns down.",
          },
          {
            name:  "Perfecto",
            gloss: "Tapered at both ends",
            desc:  "The oldest cigar shape, the one the Ta\u00ed\u00f1o were rolling before any Spaniard stepped on a beach. A well-made perfecto changes character three times before it ends, essentially three cigars in one.",
          },
          {
            name:  "Belicoso",
            gloss: "Short, stout, tapered cap",
            desc:  "Smaller than a torpedo, more compact, often a slightly thicker ring gauge. Punchy. The figurado for when there is no time for ceremony.",
          },
          {
            name:  "Diadema",
            gloss: "A statement piece",
            desc:  "Very long, sometimes ten inches or more, tapered at one or both ends. Not for a Tuesday.",
          },
          {
            name:  "Culebra",
            gloss: "Three braided panatelas",
            desc:  "Three thin panatelas braided together, untwisted and smoked one at a time. Once a way to give factory workers a daily ration that could not easily be smuggled. Now a curiosity, mostly bought as a conversation piece.",
          },
        ].map((item, i) => (
          <div
            key={item.name}
            style={{
              padding:      i % 2 === 0 ? "22px 24px 22px 0" : "22px 0 22px 24px",
              borderBottom: "1px solid rgba(212,160,74,0.14)",
              borderLeft:   i % 2 === 1 ? "1px solid rgba(212,160,74,0.14)" : "none",
            }}
          >
            <div style={{ fontFamily: S.serif, fontWeight: 600, fontSize: 19, color: S.fg1, letterSpacing: "-0.005em", marginBottom: 4 }}>
              {item.name}
            </div>
            <div style={{ fontFamily: S.serif, fontStyle: "italic", fontSize: 13, color: S.gold, marginBottom: 8 }}>
              {item.gloss}
            </div>
            <p style={{ fontFamily: S.sans, fontSize: 14, color: S.fg2, lineHeight: 1.55, margin: 0 }}>
              {item.desc}
            </p>
          </div>
        ))}
