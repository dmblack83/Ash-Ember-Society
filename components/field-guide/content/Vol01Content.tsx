...
export function Vol01Content() {
  return (
    <>
      ...
      <SectionHeading>The Beach at <Em>Guanahán&iacute;</Em></SectionHeading>
      ...
      >
        {[
          ...
          >
            ...
            <div style={{ fontFamily: S.serif, fontWeight: 600, fontSize: 18, lineHeight: 1.1, marginBottom: 6, color: S.fg1 }}>
              {s.name}
            </div>
            <div style={{ fontFamily: S.sans, fontSize: 11, color: S.fg3, letterSpacing: "0.08em", textTransform: "uppercase" }}>
              <strong
                style={{
                  display:       "block",
                  color:         S.gold,
      ...
      >
        <div style={{ fontFamily: S.sans, fontSize: 10.5, letterSpacing: "0.22em", textTransform: "uppercase", color: S.fg3, marginBottom: 12 }}>
