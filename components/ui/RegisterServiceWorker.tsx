 ...
 * for static assets (CacheFirst), images (SWR), and Supabase Storage
 * public buckets (SWR), plus push notifications. Navigation HTML is
 * intentionally NOT intercepted — every page request goes straight
 * to origin to avoid serving stale cached HTML.
 */
